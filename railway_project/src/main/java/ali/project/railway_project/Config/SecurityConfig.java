...
import ali.project.railway_project.Security.JwtErrors;
import ali.project.railway_project.Security.JwtTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers("/api/clothe/**", "/api/worker/**", "/api/aware/**", "/api/shikoyatlar")
                .permitAll()
                .antMatchers("/api/**")
                .authenticated();
